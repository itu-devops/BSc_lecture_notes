GROUP_URLS = [
    ...
    [
        ...
        "Team Connie",
        # Monitoring URL:
        "https://monitor.walkablecity.app/",
        # Logging URL:
        "https://monitor.walkablecity.app/d/37bab9d9-f176-44cd-a6d5-3d2aa286a5cb/minitwit-logging-dashboard?orgId=1&from=now-6h&to=now&timezone=browser",
    ],
    [
        "group j",
        "Chirp Vee2",
